...
echo ^<font face="Lucida Console" size="10" color="#FFFFFF"^> >> bsod.hta
echo ^<p^>A problem has been detected and windows has been shutdown, cuz it couldn't handle how beautiful Isabella is!^</p^> >> bsod.hta
